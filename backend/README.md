...
## Project Structure
    ...
    ├── square_glitter_dev_80869  # Django project configurations
...
1. Clone this repo and `cd square_glitter_dev_80869`
...
2. Clone this repo and `cd square_glitter_dev_80869`
