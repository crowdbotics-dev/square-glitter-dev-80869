"""
Django settings for square_glitter_dev_80869 project.
...
ROOT_URLCONF = 'square_glitter_dev_80869.urls'
...
WSGI_APPLICATION = 'square_glitter_dev_80869.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_glitter_dev_80869 API",
    "DESCRIPTION": "API documentation for square_glitter_dev_80869 App",
    "VERSION": "v1",
}
